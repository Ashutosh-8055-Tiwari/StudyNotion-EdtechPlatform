...
export const profileEndpoints = {
  ...
  GET_ALL_INSTRUCTOR_DASHBOARD_DETAILS_API:"http://localhost:4000/api/v1/profile/getInstructorDashboardDetails",
};
...
export const courseEndpoints = {
  ...
  ADD_COURSE_TO_CATEGORY_API:"http://localhost:4000/api/v1/course/addCourseToCategory",
  SEARCH_COURSES_API:"http://localhost:4000/api/v1/course/searchCourse",
  CREATE_CATEGORY_API:"http://localhost:4000/api/v1/course/createCategory",
};
...
export const contactusEndpoint = {
  CONTACT_US_API:"http://localhost:4000/api/v1/contact/contactUs",
};
